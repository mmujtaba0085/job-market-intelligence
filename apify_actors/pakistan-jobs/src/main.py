"""
Apify Actor: Pakistan Jobs
──────────────────────────
Pulls Pakistan job postings (market=pakistan_jobs_all) from the Job Market
Intelligence API and pushes them to this run's Apify dataset.
...
_MARKET_PARAMS = {"market": "pakistan_jobs_all"}
_PAGE_SIZE = 100
